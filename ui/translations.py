translations = {
    "en": {
        ...
        "app.icon": "☢️",
        "app.menu.get_help": "https://www.example.com/help",
        "app.menu.report_bug": "https://www.example.com/bug",
    ...
    "vi": {
        ...
        "blast.damage_level_1": "Thiệt hại nhẹ (cửa sổ vỡ)",
        ...
        "blast.report_title": "Báo Cáo Phân Tích Sóng Xung Kích Hạt Nhân",
        ...
        "blast.report_distance": "Hiệu ứng tại khoảng cách {distance} mét từ tâm vụ nổ:",
        ...
        "chart.time_seconds": "Thời gian (s)",
        ...
        "chart.moderate_damage": "Thiệt hại kết cấu trung bình",
        "chart.severe_damage": "Sập đổ công trình",
        "chart.reinforced_damage": "Hư hại bê tông",
        ...
        "help.weapon_yield": "Năng lượng thiết kế tính bằng kiloton",
        "help.max_distance_km": "Khoảng cách tối đa từ tâm vụ nổ tính bằng km",
        "help.max_distance_m": "Khoảng cách tối đa từ tâm vụ nổ tính bằng mét",
        "help.burst_height_m": "Độ cao vụ nổ tính bằng mét",
        "help.burst_height_km": "Độ cao vụ nổ tính bằng km",
        "help.density": "Mật độ không khí xung quanh, mặc định là 1.225 kg/m³ (mật độ không khí ở mực nước biển)",
        "help.time_after_s": "Thời gian sau vụ nổ tính bằng giây",
        "help.time_after_h": "Thời gian sau vụ nổ tính bằng giờ",
        "help.system_radius": "Bán kính của hệ thống tính bằng cm",
        "help.neutron_count": "Số lượng neutron để mô phỏng",
        "help.initial_distribution": "Phân bố không gian ban đầu của neutron",
        "help.fission_xs": "Tiết diện phân hạch",
        "help.scattering_xs": "Tiết diện tán xạ",
        "help.absorption_xs": "Tiết diện hấp thụ",
        "help.avg_neutrons": "Số neutron trung bình sinh ra từ mỗi phản ứng phân hạch",
        ...
        "help.simulate_chain": "Mô phỏng chuỗi phản ứng phân hạch để tính hệ số nhân neutron k-hiệu quả",
        "help.multi_core": "Tăng tốc mô phỏng bằng cách sử dụng nhiều lõi CPU",
        "help.system_size": "Kích thước hệ thống tính bằng cm",
        "help.spatial_resolution": "Độ phân giải không gian",
        "help.enrichment": "Độ giàu của uranium-235",
        "help.geometry": "Hình dạng của vật liệu phân hạch",
        "help.initial_neutrons": "Số lượng neutron ban đầu",
        ...
        "help.conductivity": "Độ dẫn điện của bề mặt, đơn vị S/m (Siemens/meter)",
        "help.primary_fraction": "Tỷ lệ năng lượng từ giai đoạn đầu",
        "help.tritium": "Gam"
    }
}